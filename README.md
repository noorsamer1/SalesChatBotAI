...
An AI-powered sales analytics assistant that helps businesses analyze sales data, generate insights, and engage users via a smart chatbot.

---

## 🌟 Overview

This is an intelligent conversational AI system that transforms complex sales data into actionable business insights. It combines advanced natural language processing with sophisticated business intelligence to provide real-time analytics through natural conversation.
...
| Metric                       | Traditional Method  | With this chatbot  | Improvement         |
| ---------------------------- | ------------------- | --------------- | ------------------- |
...
**Built with ❤️ for sales and analytics teams**
...
An AI-powered sales assistant web application that helps businesses analyze sales data, generate insights, and engage with users via a smart chatbot interface. Built using FastAPI, React, and SQL, it features data visualizations, multilingual support, and real-time AI responses via OpenAI and OpenRouter APIs.
